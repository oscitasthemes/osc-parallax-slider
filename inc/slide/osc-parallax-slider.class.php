...
class OscParallaxSlide {
    ...
    public function get_slide_html() {
        if (is_admin() && isset($_GET['page']) && $_GET['page'] == 'oscparallaxslider-theme-editor') {
     ...
     * If the meta exists, update it
     */
    public function add_or_update_or_delete_bg_meta($post_id, $name, $value) {
        $key = "ml-slider_" . $name;
    ...
    public function get_thumb() {
        $imageHelper = new OscParallaxsliderImageHelper($this->slide->ID, 150,150,'false');
